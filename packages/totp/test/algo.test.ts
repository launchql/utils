...
let db: PgTestClient; // app-level client
let pg: PgTestClient; // root client
...
//     SELECT totp.base32_to_hex('OH3NUPO3WOGOZZQ4')
//   `);
...
// it('base32_to_hex', async () => {
//   const { base32_to_hex } = await pg.one(`
//     SELECT totp.base32_to_hex('pv6624hvb4kdcwe2')
//   `);
